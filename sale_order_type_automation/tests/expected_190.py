...
EXPECTED = {
    "sale.order.type": {
        ...
        # Preservación: valor que no parsea. Queda intacto y el script loguea un
        # warning para revisión manual. Si acá apareciera algo modificado, el
        # script estaría escribiendo sobre un valor que no entendió.
        ...
        # Ancla en la demo del propio módulo, no hace falta sembrarlo. Es el
        # caso más común en bases reales, y verifica que el script no le invente
        # un dominio a quien no tenía ninguno — el falso positivo más probable.
        ref("sale_order_type_automation.sale_order_type_validate_invoice_automation"): {
