...
#
# La rama de preservacion "tipo con automatizacion y sin dominio" TAMBIEN se
# siembra (sot_ivd_no_domain): la version anterior anclaba en la demo del propio
# modulo, pero el pipeline corre el -u con demo apagada y _process_end purga los
# xmlids demo no referenciados por FK — el ancla desaparecia post-migracion
# (FAIL real en el build 105875, 24/08).
#
...
CASES = [
    ...
    ("sot_ivd_empty_list", "[]"),
    # Preservacion: automatizacion activa y SIN dominio (NULL). El caso mas
    # comun en bases reales; verifica que el script no invente un dominio.
    ("sot_ivd_no_domain", False),
]
